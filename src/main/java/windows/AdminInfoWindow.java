...
public class AdminInfoWindow extends JFrame {
	 ...
	 * Runnable() { public void run() { try { AdminInfoWindow frame = new
	 * AdminInfoWindow(); frame.setVisible(true); } catch (Exception e) {
	 * e.printStackTrace(); } } });
	 * 
	 * }// main
	 */
	...
	public AdminInfoWindow(final int index) {
		...
		lblAdministrator.setFont(new Font("SansSerif", Font.BOLD | Font.ITALIC, 57));
		lblAdministrator.setBounds(192, 0, 458, 90);
		contentPane.add(lblAdministrator);

		JLabel nameLabel = new JLabel("Name");
		nameLabel.setHorizontalAlignment(SwingConstants.CENTER);
		nameLabel.setForeground(Color.BLACK);
		nameLabel.setFont(new Font("SansSerif", Font.BOLD, 21));
		...
		ageLabel.setFont(new Font("SansSerif", Font.BOLD, 21));
		...
		streetLabel.setFont(new Font("SansSerif", Font.BOLD, 21));
		streetLabel.setBounds(119, 218, 272, 45);
		...
		houseLabel.setFont(new Font("SansSerif", Font.BOLD, 21));
		houseLabel.setBounds(119, 280, 272, 50);
		contentPane.add(houseLabel);

		JLabel cityLabel = new JLabel("City");
		cityLabel.setHorizontalAlignment(SwingConstants.CENTER);
		cityLabel.setForeground(Color.BLACK);
		cityLabel.setFont(new Font("SansSerif", Font.BOLD, 21));
		cityLabel.setBounds(119, 348, 272, 45);
		...
		salaryLabel.setFont(new Font("SansSerif", Font.BOLD, 21));
		salaryLabel.setBounds(119, 418, 272, 45);
		...
		name.setFont(new Font("SansSerif", Font.PLAIN, 21));
		...
		age.setFont(new Font("SansSerif", Font.PLAIN, 21));
		...
		street.setFont(new Font("SansSerif", Font.PLAIN, 21));
		street.setBounds(401, 215, 272, 45);
		...
		house.setFont(new Font("SansSerif", Font.PLAIN, 21));
		house.setBounds(401, 280, 272, 50);
		...
		city.setFont(new Font("SansSerif", Font.PLAIN, 21));
		city.setBounds(401, 348, 272, 45);
		...
		username.setFont(new Font("SansSerif", Font.PLAIN, 21));
		username.setBounds(401, 418, 272, 45);
		...
		separator_2.setBounds(129, 274, 521, 9);
		contentPane.add(separator_2);

		JSeparator separator_3 = new JSeparator();
		separator_3.setBounds(129, 341, 521, 9);
		contentPane.add(separator_3);

		JSeparator separator_4 = new JSeparator();
		separator_4.setBounds(139, 404, 521, 9);
		contentPane.add(separator_4);

		JLabel lblPassword = new JLabel("Password");
		lblPassword.setHorizontalAlignment(SwingConstants.CENTER);
		lblPassword.setForeground(Color.BLACK);
		lblPassword.setFont(new Font("SansSerif", Font.BOLD, 21));
		lblPassword.setBounds(121, 481, 272, 45);
		...
		label_2.setFont(new Font("SansSerif", Font.PLAIN, 21));
		label_2.setBackground(Color.WHITE);
		label_2.setBounds(401, 481, 272, 45);
		contentPane.add(label_2);

		JSeparator separator_5 = new JSeparator();
		separator_5.setBounds(129, 474, 521, 9);
	...
	/*
	 * public AdminInfoWindow() { setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	 * setBounds(100, 100, 820, 698); contentPane = new JPanel();
	 * contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
	 * setContentPane(contentPane); contentPane.setLayout(null);
	 * 
	 * JLabel label = new JLabel("Admin"); label.setFont(new Font("SansSerif",
	 ...
	 * Font.BOLD, 18)); nameLabel.setBounds(119, 101, 272, 45);
	 * contentPane.add(nameLabel);
	 * 
	 * JLabel ageLabel = new JLabel("Age");
	 * ageLabel.setHorizontalAlignment(SwingConstants.CENTER);
	 * ageLabel.setForeground(Color.BLACK); ageLabel.setFont(new Font("SansSerif",
	 * Font.BOLD, 18)); ageLabel.setBounds(119, 157, 272, 45);
	 * contentPane.add(ageLabel);
	 * 
	 * JLabel streetLabel = new JLabel("Street");
	 * streetLabel.setHorizontalAlignment(SwingConstants.CENTER);
	 * streetLabel.setForeground(Color.BLACK); streetLabel.setFont(new
	 * Font("SansSerif", Font.BOLD, 18)); streetLabel.setBounds(119, 213, 272, 45);
	 * contentPane.add(streetLabel);
	 * 
	 * JLabel houseLabel = new JLabel("House Number");
	 * houseLabel.setHorizontalAlignment(SwingConstants.CENTER);
	 * houseLabel.setForeground(Color.BLACK); houseLabel.setFont(new
	 * Font("SansSerif", Font.BOLD, 18)); houseLabel.setBounds(119, 269, 272, 50);
	 * contentPane.add(houseLabel);
	 * 
	 * JLabel cityLabel = new JLabel("City");
	 * cityLabel.setHorizontalAlignment(SwingConstants.CENTER);
	 * cityLabel.setForeground(Color.BLACK); cityLabel.setFont(new Font("SansSerif",
	 * Font.BOLD, 18)); cityLabel.setBounds(119, 333, 272, 45);
	 * contentPane.add(cityLabel);
	 * 
	 * JLabel salaryLabel = new JLabel("Username");
	 * salaryLabel.setHorizontalAlignment(SwingConstants.CENTER);
	 * salaryLabel.setForeground(Color.BLACK); salaryLabel.setFont(new
	 * Font("SansSerif", Font.BOLD, 18)); salaryLabel.setBounds(129, 406, 272, 45);
	 * contentPane.add(salaryLabel);
	 * 
	 ...
	 * contentPane.add(btnUpdateInfo);
	 * 
	 * JLabel name = new JLabel(""); name.setBackground(Color.WHITE);
	 * name.setHorizontalAlignment(SwingConstants.CENTER);
	 * name.setForeground(Color.RED); name.setFont(new Font("SansSerif", Font.BOLD,
	 * 16)); name.setBounds(401, 98, 272, 45); contentPane.add(name);
	 * 
	 * JLabel age = new JLabel("hahaha"); age.setBackground(Color.WHITE);
	 * age.setHorizontalAlignment(SwingConstants.CENTER);
	 * age.setForeground(Color.RED); age.setFont(new Font("SansSerif", Font.BOLD,
	 * 16)); age.setBounds(401, 157, 272, 42); contentPane.add(age);
	 * 
	 ...
	 * Font.BOLD, 16)); street.setBounds(401, 210, 272, 45);
	 * contentPane.add(street);
	 * 
	 ...
	 * Font.BOLD, 16)); house.setBounds(401, 269, 272, 50); contentPane.add(house);
	 * 
	 * JLabel city = new JLabel("hahaha"); city.setBackground(Color.WHITE);
	 * city.setHorizontalAlignment(SwingConstants.CENTER);
	 * city.setForeground(Color.RED); city.setFont(new Font("SansSerif", Font.BOLD,
	 * 16)); city.setBounds(401, 333, 272, 45); contentPane.add(city);
	 * 
	 * JLabel username = new JLabel("hahaha"); username.setBackground(Color.WHITE);
	 * username.setHorizontalAlignment(SwingConstants.CENTER);
	 * username.setForeground(Color.RED); username.setFont(new Font("SansSerif",
	 * Font.BOLD, 16)); username.setBounds(411, 406, 272, 45);
	 * contentPane.add(username);
	 * 
	 * JSeparator separator = new JSeparator(); separator.setBounds(129, 154, 521,
	 * 9); contentPane.add(separator);
	 * 
	 * JSeparator separator_1 = new JSeparator(); separator_1.setBounds(129, 210,
	 * 521, 9); contentPane.add(separator_1);
	 * 
	 * JSeparator separator_2 = new JSeparator(); separator_2.setBounds(129, 269,
	 * 521, 9); contentPane.add(separator_2);
	 * 
	 * JSeparator separator_3 = new JSeparator(); separator_3.setBounds(129, 316,
	 * 521, 9); contentPane.add(separator_3);
	 * 
	 * JSeparator separator_4 = new JSeparator(); separator_4.setBounds(139, 389,
	 * 521, 9); contentPane.add(separator_4);
	 * 
	 * JLabel lblPassword = new JLabel("Password");
	 * lblPassword.setHorizontalAlignment(SwingConstants.CENTER);
	 * lblPassword.setForeground(Color.BLACK); lblPassword.setFont(new
	 * Font("SansSerif", Font.BOLD, 18)); lblPassword.setBounds(119, 489, 272, 45);
	 * contentPane.add(lblPassword);
	 * 
	 * JLabel password = new JLabel("hahaha");
	 * password.setHorizontalAlignment(SwingConstants.CENTER);
	 * password.setForeground(Color.RED); password.setFont(new Font("SansSerif",
	 * Font.BOLD, 16)); password.setBackground(Color.WHITE); password.setBounds(384,
	 * 489, 272, 45); contentPane.add(password);
	 * 
	 * JSeparator separator_5 = new JSeparator(); separator_5.setBounds(103, 469,
	 * 521, 9); contentPane.add(separator_5);
	 * 
	 * }
	 */
