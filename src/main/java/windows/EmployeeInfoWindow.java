...
public class EmployeeInfoWindow extends JFrame {
	...
	public EmployeeInfoWindow(int index) {
		...
		JLabel name = new JLabel("Name: " + AddEmployeeWindow.getEmployees().get(index).getName());
		name.setForeground(Color.BLACK);
		name.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 25));
		name.setBounds(37, 122, 515, 45);
		contentPane.add(name);

		JLabel age = new JLabel("Age: " + AddEmployeeWindow.getEmployees().get(index).getAge());
		...
		JLabel street = new JLabel(
				"Street: " + AddEmployeeWindow.getEmployees().get(index).getAddress().getStreetName());
		...
		JLabel house = new JLabel(
				"House Num: " + AddEmployeeWindow.getEmployees().get(index).getAddress().getHouseNumber());
		...
		JLabel city = new JLabel("City: " + AddEmployeeWindow.getEmployees().get(index).getAddress().getCity());
		city.setForeground(Color.BLACK);
		city.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 25));
		city.setBounds(52, 372, 490, 29);
		contentPane.add(city);

		JLabel salary = new JLabel("Salary: " + AddEmployeeWindow.getEmployees().get(index).getSalary());
