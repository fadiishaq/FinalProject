...
public class EmployeeInfoWindow extends JFrame {
	 ...
	 * Runnable() { public void run() { try { EmployeeInfoWindow frame = new
	 * EmployeeInfoWindow(); frame.setVisible(true); } catch (Exception e) {
	 * e.printStackTrace(); } } });
	 * 
	 * }// main
	 */
			...
			btnNext.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (SearchPersonWindow.getEmployeesFound().size() == 2) {
						...
						if (SearchPersonWindow.getPersonsFound().get(1) instanceof Employee) {

							SearchPersonWindow.employeeWin2 = new EmployeeInfoWindow(SearchPersonWindow.getPersonsFound().get(1).getIndex(),	false);
							SearchPersonWindow.employeeWin1.setVisible(false);
							SearchPersonWindow.employeeWin2.setVisible(true);

						}
						else 	if (SearchPersonWindow.getPersonsFound().get(1) instanceof Student) {

							SearchPersonWindow.studentWin1 = new StudentInfoWindow(SearchPersonWindow.getPersonsFound().get(1).getIndex(),	false);
							setVisible(false);
	...
	/*
	 * public EmployeeInfoWindow() { setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
